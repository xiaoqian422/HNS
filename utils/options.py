...
def get_args():
    ...
    parser.add_argument("--temperature", type=float, default=0.001, help="initial temperature value, if 0, don't use temperature 0.02")
    ...
    parser.add_argument("--text_length", type=int, default=77, help="77")
    ...
    parser.add_argument("--target_lr", type=float, default=0.000001)
    ...
    parser.add_argument('--false_margin', default=0.999, type=float,help='lambda')
    parser.add_argument('--margin', default=0.2, type=float,help='Rank loss margin.')
    parser.add_argument('--nums_right_sims', default=200, type=int,help='number of average sims can use.')
    parser.add_argument('--match_para', default=10000, type=int,help='the probability for event 𝑐, 1/c')
    parser.add_argument('--num_negatives', default=10, type=int, help='the number of negative sample')
    parser.add_argument('--queue_size', default=8192, type=int,help='Number of memory queue8224,65536,8192.')
    parser.add_argument('--momentum_par', default=0.995, type=float,help='Momentum parameter.  0.995')
    parser.add_argument('--false_num', default=100, type=float)
